object frm_cadbanc: Tfrm_cadbanc
  Left = 267
  Top = 188
  Width = 448
  Height = 413
    ...
    object Panel2: TPanel
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'codorig_banc'
            Title.Alignment = taCenter
            Title.Caption = 'C'#243'digo do banco'
            Visible = True
          end
          item
            Expanded = False
  ...
  object tbl_banc: TADOTable
    Active = True
    Connection = dmfolha.QF_DB
    CursorType = ctStatic
    IndexFieldNames = 'cod_banc'
    TableName = 'tbl_banc'
    Left = 322
    Top = 72
    object tbl_banccod_banc: TAutoIncField
      FieldName = 'cod_banc'
      ReadOnly = True
    end
    object tbl_banccodorig_banc: TWideStringField
      FieldName = 'codorig_banc'
    end
    object tbl_bancnome_banc: TWideStringField
      FieldName = 'nome_banc'
      Size = 30
    end
  end
  object dat_banc: TDataSource
    DataSet = tbl_banc
    OnStateChange = dat_bancStateChange
    Left = 350
    Top = 72
  end
end
